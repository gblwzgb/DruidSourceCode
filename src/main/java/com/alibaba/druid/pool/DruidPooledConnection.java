...
public class DruidPooledConnection extends PoolableWrapper implements javax.sql.PooledConnection, Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        // 设置了maxPoolPreparedStatementPerConnectionSize会为true
        // 即每个连接，最多可以缓存几个PreparedStatements，内部使用的LRU缓存
        ...
        if (stmtHolder == null) {
            try {
                // 调用底层连接的prepareStatement方法，然后封装成PreparedStatementHolder
        ...
        // 再封装一次，成DruidPooledPreparedStatement
        DruidPooledPreparedStatement rtnVal = new DruidPooledPreparedStatement(this, stmtHolder);

        // 添加DruidPooledPreparedStatement到追踪中
